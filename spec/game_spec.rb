require 'game'
 RSpec.describe Game, "kills" do
    ...
    it "should have a value 0 as default for a key" do
      game = Game.new(0)
    ...
    it "should keep the kills even when player change his/her name" do
      game = Game.new(0)
      game.new_player("Marianne")
      game.kill("Marianne", "0")
    ...
    it "decreases a player score whenever a world_kill happens to him/her" do
      game = Game.new(0)
      game.new_player("Marianne")
      game.kill("Marianne", "0")
      expect(game.kills["Marianne"]).to eq 1
